...
if (isset($_POST['submit'])) {
    ...
    $sql = "update blog set topic='$topic',title='$title',author='$author',date='$date',description='$description',image='$images' where id='$id'";
            ...
            <div class="form-records">
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    while ($row = mysqli_fetch_assoc($result)):
                        ...
                        <div class="form-group">
                            <select type="text" name="topic" class="form-control" value="<?php echo $row['topic'] ?>"
                                required>
                        ...
                        <div class="form-group">
                            <textarea name="description" id="editor" value="<?php echo $row['description'] ?>"
                        ...
                        <div class="form-group">
                            ...
                            <img src="../Image/<?php echo $row['image'] ?>" alt="" width="100" height="100" />
                            <input type="hidden" name="img" class="form-control" required>
                        </div>
